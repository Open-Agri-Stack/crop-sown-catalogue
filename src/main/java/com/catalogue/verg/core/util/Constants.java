...
public class Constants{
    ...
    // Plannedinput Specific Constants
    public static final String PLANNEDINPUT_VALIDATION_FILE_JSON = "/payloadValidation/plannedinputPayloadValidation.json";
    public static final String PLANNEDINPUT_ID_RQST = "plannedinputId";
    public static final String PLANNEDINPUT_INDEX_NAME = "plannedinput_index";

    
    // Actualinput Specific Constants
    public static final String ACTUALINPUT_VALIDATION_FILE_JSON = "/payloadValidation/actualinputPayloadValidation.json";
    public static final String ACTUALINPUT_ID_RQST = "actualinputId";
    public static final String ACTUALINPUT_INDEX_NAME = "actualinput_index";

    
    // Sowingdetails Specific Constants
    public static final String SOWINGDETAILS_VALIDATION_FILE_JSON = "/payloadValidation/sowingdetailsPayloadValidation.json";
    public static final String SOWINGDETAILS_ID_RQST = "sowingdetailsId";
    public static final String SOWINGDETAILS_INDEX_NAME = "sowingdetails_index";

    
    // Harvestingdetails Specific Constants
    public static final String HARVESTINGDETAILS_VALIDATION_FILE_JSON = "/payloadValidation/harvestingdetailsPayloadValidation.json";
    public static final String HARVESTINGDETAILS_ID_RQST = "harvestingdetailsId";
    public static final String HARVESTINGDETAILS_INDEX_NAME = "harvestingdetails_index";
